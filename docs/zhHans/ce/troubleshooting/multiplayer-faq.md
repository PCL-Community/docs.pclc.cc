...
[打开介绍文章](https://tailscale.com/blog/how-nat-traversal-works)
...
IPv6 是互联网协议的最新版本，旨在解决 IPv4 地址枯竭问题，提供近乎无限的地址空间。
...
请先检查联机设置中的 EasyTier 设置，请确保你的节点行为设置中允许"自有节点"加入帮助互相发现。如果多次尝试无果可以在设置中加入其他社区节点辅助连接。

[获取社区节点](https://uptime.easytier.cn/)
